...
// `subject` is lower-case "dbt" deliberately — the product is never capitalised, and this string is
// the catalog's h1. No `eyebrow` prop: the section eyebrow is `text-transform: uppercase` in the
// shell's stylesheet, so "dbt" and the default subject.toUpperCase() render identically ("DBT").
